...
export class Wallet extends Model({
    ...
    * loadTransactions(init = false) {
        ...
        try {
            ...
            const storedTransactions = (yield* _await(localStorage.load(`wootzapp-pending-transactions-eth-${getEVMProvider().currentNetwork.chainID}-${this.address}`))) || {}
    ...
    * getTokenTransactions(init = false) {
        ...
        try {
            ...
            const storedTransactions = (yield* _await(localStorage.load(`wootzapp-pending-transactions-token-${getEVMProvider().currentNetwork.chainID}-${this.address}`))) || {}
