...
export class NativeTransaction extends Model({
    ...
    * storeTransaction() {
        ...
        const transactions = (yield* _await(localStorage.load(`wootzapp-pending-transactions-eth-${this.chainId}-${this.walletAddress}`))) || {}
        transactions[saveTx.hash] = saveTx
        _await(localStorage.save(`wootzapp-pending-transactions-eth-${this.chainId}-${this.walletAddress}`, transactions))
    }
