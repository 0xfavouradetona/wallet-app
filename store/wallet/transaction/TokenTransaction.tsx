...
export class TokenTransaction extends Model({
    ...
    * storeTransaction() {
        ...
        const transactions = (yield* _await(localStorage.load(`wootzapp-pending-transactions-token-${this.chainId}-${this.walletAddress}`))) || {}
        transactions[saveTx.transactionHash] = saveTx
        _await(localStorage.save(`wootzapp-pending-transactions-token-${this.chainId}-${this.walletAddress}`, transactions))
    }
