...
# for android
cp node_modules/ethereum-provider/dist/wootzapp-provider.js android/app/src/main/assets/provider.js
# for ios
cp node_modules/ethereum-provider/dist/wootzapp-provider.js provider/provider.js